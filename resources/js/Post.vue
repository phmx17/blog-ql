    ...
    <div class="container mx-auto px-4 w-full md:w-3/4 lg:w-3/5 xl:w-1/2 mt-20">
      ...
      <div v-else>
        ...
        <div class="mb-24 flex">
          <div class="mr-6">
            <img :src="'/storage/faces/' + post.author.avatar" alt="author avatar" class="w-16 h-16 rounded-full" /> <!-- this path does not match the actual one or the one suggested by intellisense -->
          </div>
